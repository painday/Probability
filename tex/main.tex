...
那么就有 $k+1=(\underbrace{k_s\cdots k_{q+1}}_{s-q}\underbrace{10\cdots 0}_{q-t} \underbrace{k_t\cdots k_0}_{t+1})_2.$ 
此时 $a_{k+1}=(0.\underbrace{0\cdots 0}_{n-s-2}1\underbrace{k_t\cdots k_0}_{t+1})_3,\ b_k=(0.\underbrace{0\cdots 0}_{n-s-1}\underbrace{2\cdots 2}_{s+1})_3,\ 2b_k=(0.\underbrace{0\cdots 0}_{n-s-2}1\underbrace{2\cdots 2}_{s}1)_3,$ 因此 
${2b_k+a_{k+1}\over 3}=(0.\underbrace{0\cdots 0}_{n-s-1}\underbrace{2\cdots 2}_{s+1}1)_3.$
